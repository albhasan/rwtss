...
<<retrieveData, fig=TRUE>>=
df$MOD09Q1.datasets.timeline <- as.Date(
  df$MOD09Q1.datasets.timeline, '%m/%d/%Y')

plot(x = df$MOD09Q1.datasets.timeline, y = df$MOD09Q1.datasets.red, type = "l", col = "red", main = "MOD09Q1 - RED and NIR", xlab = "time", ylab = "Value")
lines(x = df$MOD09Q1.datasets.timeline, y = df$MOD09Q1.datasets.nir, col = "dark red")
